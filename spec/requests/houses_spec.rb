...
RSpec.describe 'Houses API', type: :request do
  path '/houses' do # rubocop:todo Metrics/BlockLength
    ...
    post 'Creates a house' do
      ...
      parameter name: :house, in: :body, schema: {
        ...
        required: %w[name description price city adress available user_id]
      }
  ...
  path '/houses/{id}' do # rubocop:todo Metrics/BlockLength
    ...
    patch 'Updates a house' do # rubocop:todo Metrics/BlockLength
      tags 'Houses'
      consumes 'application/json', 'application/xml'
      parameter name: :id, in: :path, type: :string
      parameter name: :house, in: :body, schema: {
