    ...
    path '/users' do
        post 'Creates a user' do
            ...
            response '201', 'user created' do
                let(:user) { { username: 'test', email: 'test@example.com', password: '123456aa', password_confirmation: '123456aa' } }
                run_test!
            end
        ...
        path '/users/{username}' do
            get 'Retrieves a user' do
                ...
                response '200', 'user found' do
                    ...
                    required: [ 'data' ]
                    let(:username) { User.create(username: 'test', email: 'mail1@mail.com', password: '123456aa', password_confirmation: '123456aa').username }
                    run_test!
                end
            end
